...
**PHP Notice:  errors will be displayed if the created wordpress site uses https but they can be safely ignored as they will not affect the function of a backup or restore.
